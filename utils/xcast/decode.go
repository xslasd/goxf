...
func Decode(m any, val any) error {
...
func decode(data any, val reflect.Value) error {
...
func decodeStruct(data any, val reflect.Value) error {
...
func decodePtr(data any, val reflect.Value) error {
	valType := val.Type()
...
func decodeBool(data any, val reflect.Value) error {
	dataVal := reflect.ValueOf(data)
	dataKind := dataVal.Kind()
	switch dataKind {
	case reflect.Bool:
	...
	case reflect.String:
		...
		val.SetBool(ok)
	default:
		return fmt.Errorf("cannot convert %s to bool", dataKind)
...
func decodeInt(data any, val reflect.Value) error {
	dataVal := reflect.ValueOf(data)
	dataKind := dataVal.Kind()
	switch dataKind {
	case reflect.Bool:
...
func decodeUint(data any, val reflect.Value) error {
	dataVal := reflect.ValueOf(data)
	dataKind := dataVal.Kind()
	switch dataKind {
	case reflect.Bool:
...
func decodeString(data any, val reflect.Value) error {
	dataVal := reflect.ValueOf(data)
	dataKind := dataVal.Kind()
	switch dataKind {
	case reflect.Bool:
...
func decodeFloat(data any, val reflect.Value) error {
	dataVal := reflect.ValueOf(data)
	dataKind := dataVal.Kind()
	switch dataKind {
	case reflect.Bool:
	...
	case reflect.String:
		...
		val.SetFloat(f)
	default:
		return fmt.Errorf("cannot convert %s to float", dataKind)
	}
	return nil
}
